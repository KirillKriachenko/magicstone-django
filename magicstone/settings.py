"""
Django settings for magicstone project.
...
SECRET_KEY = '%i(xz(7pi2lw$oi_o#a9z#0usppi3ai&*p!u-o&)pxbg6!df-l'
...
WSGI_APPLICATION = 'magicstone.wsgi.application'
